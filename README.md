...
![Version: 1.0.0-RC10](https://img.shields.io/badge/Version-1.0.0--RC10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0-RC10](https://img.shields.io/badge/AppVersion-1.0.0--RC10-informational?style=flat-square) ![Tag](https://img.shields.io/static/v1?label=&message=LeadingRepository&color=green&style=flat)
...
For further information please refer to the [technical documentation](https://github.com/eclipse-tractusx/portal-assets/tree/1.0.0-RC10/developer/Technical%20Documentation).
...
| frontend.portal.image.portaltag | string | `"1.0.0-RC10"` |  |
...
| frontend.registration.image.registrationtag | string | `"1.0.0-RC6"` |  |
| frontend.assets.name | string | `"assets"` |  |
| frontend.assets.image.name | string | `"ghcr.io/catenax-ng/tx-portal-assets"` |  |
| frontend.assets.image.assetstag | string | `"1.0.0-RC8"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.provisioning.service.image.provisioningservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v1.0.0-RC10"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.services.image.servicesservicetag | string | `"v1.0.0-RC10"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v1.0.0-RC10"` |  |
...
| backend.checklistworker.image.checklistworkertag | string | `"v1.0.0-RC10"` |  |
